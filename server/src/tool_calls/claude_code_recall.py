...
from tool_calls.claude_code_query import ClaudeCodeQuery
...
def handle_search_claude_conversations_enhanced(
    ...
    try:
        ...
        data = query_tool.search_conversations(
            query, project_root, limit=limit * 2
        )  # Get more for filtering
        ...
        for result in results:
            ...
            for match in result["matches"]:
                match_data = {
                    "snippet": match["snippet"][:CONVERSATION_SNIPPET_MAX_LENGTH],
