...
def create_lightweight_conversation(
    ...
    return {
        "id": conv_id[:LIGHTWEIGHT_CONVERSATION_ID_LIMIT],
        "title": (
            title[:LIGHTWEIGHT_CONVERSATION_TITLE_LIMIT] + "..."
            if len(title) > LIGHTWEIGHT_CONVERSATION_TITLE_LIMIT
            else title
        ),
        ...
        "snippet": (
            snippet[:LIGHTWEIGHT_CONVERSATION_SNIPPET_LIMIT] + "..."
            if len(snippet) > LIGHTWEIGHT_CONVERSATION_SNIPPET_LIMIT
            else snippet
        ),
    }
