...
from src.tool_calls.windsurf_recall import handle_recall_windsurf_conversations
...
class TestWindsurfRecall:
    ...
    def test_handle_recall_windsurf_conversations_basic(self):
        ...
        with patch(
            "src.tool_calls.windsurf_recall.WindsurfQuery"
        ) as mock_query_class, patch(
            "src.tool_calls.windsurf_recall.generate_shared_context_keywords"
        ) as mock_keywords, patch(
            "src.tool_calls.windsurf_recall.analyze_session_relevance"
        ) as mock_analyze:
    ...
    def test_handle_recall_windsurf_conversations_with_relevance_filtering(self):
        """Test recall with relevance score filtering."""
        arguments = {"fast_mode": True, "limit": 10, "min_score": 4.0}  # High threshold
    ...
    def test_handle_recall_windsurf_conversations_conversation_standardization(self):
        ...
        for fast_mode in [True, False]:
            ...
            with patch(
                ...
                def mock_analyze_side_effect(
                    conv, keywords, project_root, fast_mode_param=True
                ):
                    return {
                        "relevance_score": 5.0,
                        "snippet": f"Snippet for {conv.get('id', 'unknown')}",
    ...
    def test_handle_recall_windsurf_conversations_date_filtering(self):
        ...
        with patch(
            ...
            "src.tool_calls.windsurf_recall.filter_conversations_by_date"
