...
readonly SCRIPTS_DIR="$(dirname "$SCRIPT_PATH")"



readonly SERVER_SCRIPT="$SERVER_DIR/src/main.py"

usage() {
    cat <<'EOF'
Usage: gandalf conv [COMMAND] [OPTIONS]
...
{"jsonrpc": "2.0", "method": "initialize", "id": 1, "params": {"protocolVersion": "2025-06-18", "capabilities": {}, "clientInfo": {"name": "gandalf-cli", "version": "1.0.0"}}}
