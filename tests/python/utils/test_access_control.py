...
class TestAccessValidator:
    ...
    def test_validate_string_valid(self):
        ...
        valid, error = AccessValidator.validate_string("valid_string", "test_field")
    ...
    def test_validate_string_too_long(self):
        ...
        long_string = "a" * 60000
        valid, error = AccessValidator.validate_string(long_string, "test_field")
        assert valid is False
    ...
    def test_validate_array_too_many_items(self):
        ...
        valid, error = AccessValidator.validate_array(large_array, "test_field")
        assert valid is False
        assert "cannot exceed" in error

    def test_validate_path_valid(self):
        """Test valid path validation."""
        valid, error = AccessValidator.validate_path("/private/etc/passwd", "test_path")
    ...
    def test_validate_integer_not_integer(self):
        ...
        valid, error = AccessValidator.validate_integer("not_int", "test_field")
        assert valid is False
